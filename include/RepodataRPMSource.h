#ifndef REPODATARPMSOURCE_H
#define REPODATARPMSOURCE_H
...
class RepodataRPMSource {

	public:
	RepodataRPMSource( const std::string& basePath ) ;
...
#endif // #ifndef REPODATARPMSOURCE_H
